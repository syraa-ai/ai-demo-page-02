        ...
        <div className="container mx-auto px-6 py-12 max-w-4xl">
          <div className="bg-card rounded-lg shadow-lg p-8 border border-border">
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-foreground">
              <p className="text-muted-foreground leading-relaxed">Welcome, and thank you for your interest in syraa.live Inc. (<strong className="text-foreground">"Syraa," "we,"</strong> or <strong className="text-foreground">"us"</strong>) and our website at <a href="https://www.syraa.live/" className="text-primary hover:text-primary/80 underline">www.syraa.live</a>, along with our related websites, hosted applications, and other services provided by us (collectively, the <strong className="text-foreground">"Service"</strong>). These Terms of Service are a legally binding contract between you and Syraa regarding your use of the Service.</p>
              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">Except as described in Section 17.2 (Exceptions) and 17.3 (Opt-Out), you and Syraa agree that every dispute arising in connection with these Terms, the Service, or communications from us will be resolved through binding arbitration. Arbitration uses a neutral arbitrator instead of a judge or jury, is less formal than a court proceeding, may allow for more limited discovery than in court, and is subject to very limited review by courts. This agreement to arbitrate disputes includes all claims whether based in contract, tort, statute, fraud, misrepresentation, or any other legal theory, and regardless of whether a claim arises during or after the termination of these Terms. Any dispute relating to the interpretation, applicability, or enforceability of this binding arbitration agreement will be resolved by the arbitrator.</p>
                  
                  <div className="bg-red-500/10 p-4 border-l-4 border-red-500 text-sm font-bold mt-4 rounded-r-lg">
                    <p className="text-foreground">YOU UNDERSTAND AND AGREE THAT, BY ENTERING INTO THESE TERMS, YOU AND SYRAA ARE EACH WAIVING THE RIGHT TO A TRIAL BY JURY OR TO PARTICIPATE IN A CLASS ACTION.</p>
                  </div>
                </section>

                <section>
                  <h2 className="text-2xl font-semibold mb-4 text-foreground">18. Miscellaneous</h2>
                  <h3 className="text-xl font-medium mb-3 text-foreground">18.2 Governing Law</h3>
                  <p className="text-muted-foreground leading-relaxed">These Terms are governed by the laws of India without regard to conflict of law principles. You and Syraa submit to the personal and exclusive jurisdiction of the state courts located within New Delhi, India for resolution of any lawsuit or court proceeding permitted under these Terms.</p>
                  
                  <h3 className="text-xl font-medium mb-3 mt-6 text-foreground">18.3 Privacy Policy</h3>
                  <p className="text-muted-foreground leading-relaxed">Please read the Syraa Privacy Policy [<a href="/privacy-policy" className="text-primary hover:text-primary/80 underline">Privacy Policy</a>] (the <strong className="text-foreground">"Privacy Policy"</strong>) carefully for information relating to our collection, use, storage, and disclosure of your personal information. The Syraa Privacy Policy is incorporated by this reference into, and made a part of, these Terms.</p>
                </section>
              </div>
