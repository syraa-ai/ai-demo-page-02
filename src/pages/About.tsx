            ...
            <div className="space-y-8">
              <section className="space-y-4">
                <p className="text-foreground leading-relaxed">
                  At Syraa, we believe artificial intelligence is not just a future possibility—it's a present-day catalyst for transformation. In a world where time is scarce, customer expectations are rising, and operational complexity is increasing, businesses need intelligent systems that can adapt, learn, and assist autonomously. Syraa is built to be that bridge—between cutting-edge AI research and practical, business-ready deployment.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-foreground leading-relaxed">
                  We're not stopping at small businesses. Our platform is designed to be modular, industry-agnostic, and future-ready—allowing us to expand into logistics, finance, education, and more. Whether it's streamlining customer service, automating onboarding, or providing voice-based task assistance, Syraa adapts to your unique context with minimal setup.
                </p>
              </section>
            </div>
          </div>
